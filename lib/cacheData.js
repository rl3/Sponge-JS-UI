...
var cachedMethodUrl= {
    ...
    'getTagsByTypeVersion':    function( objectType, versions ) {
        ...
        return join('DataObj/getTagsByTypeVersion', objectType, versions) + query({ withLocation: true });
    },
    ...
    'getAllRoles':             function()          { return 'SourceTemplate/getAllRoles'; },
    'getUserData':             function( username) { return join('SourceTemplate/getUser', username); },
    'saveUser':                function( userData ) { return {
        url: join('SourceTemplate/saveUser', userData._id || 0),
        data: userData,
        method: 'PUT',
    }; },
    'removeUser':              function( userId ) { return join('SourceTemplate/removeUser', userId); },
