...
var cachedMethodUrl= {
    ...
    'getTagsByTypeVersion':    function( objectType, versions ) {
        ...
        return 'AgroObj/getTagsByTypeVersion/' + objectType + '/' + versions;
    },
    'getMapnamesByTypeVersion':    function( objectType, versions ) {
        if ( _.isArray(versions) ) versions= versions.join('-');
        return 'AgroObj/getMapnamesByTypeVersion/' + objectType + '/' + versions;
    },
...
DataObjectTools.oid2Str= oid2Str;
DataObjectTools.str2Oid= str2Oid;
