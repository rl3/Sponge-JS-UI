...
var cachedMethodUrl= {
    ...
    'exportByMapTypeLocation': function( map, type, lon, lat, start, end, step, format ) {
        return join('ParameterSetData/getByMapTypeLocation', map, type, lon, lat, start)    + query({ end: end, step: step, format: format || 'xml', delivery: 'url' });
    },
};
