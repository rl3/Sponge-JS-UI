...
var cachedMethodUrl= {
    ...
    'getDataObject':           function( id )      { return 'DataObj/getByObjectId/' + oid2Str(id); },
    ...
    'getJobResultMap':         function( jobId, path, data ) { return {
        url: 'Job/getResultMap/' + jobId + '/' + path + '?format=json',
        data: data,
        method: 'PUT',
    }; },
